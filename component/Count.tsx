              ...
              <div className="row">
                <div className="col-md-6 d-md-flex align-items-md-stretch">
                  <div className="count-box">
                    ...
                    <p>
                        <strong>Organic Reach</strong> (Global)</p>
                  </div>
                </div>
                ...
                <div className="col-md-6 d-md-flex align-items-md-stretch">
                  <div className="count-box">
                    ...
                    <CountUp
                    enableScrollSpy={true}
                    end={14081} /><p><strong>Watch Hours</strong> (Asia) </p>
                  </div>
                </div>
                ...
                <div className="col-md-6 d-md-flex align-items-md-stretch">
                  <div className="count-box">
                    ...
                    {/* <span data-purecounter-start="0" data-purecounter-end="17" data-purecounter-duration="1" className="purecounter"><p>%</p></span> */}
                    <CountUp
                    enableScrollSpy={true}
                    redraw
                    end={17} />
